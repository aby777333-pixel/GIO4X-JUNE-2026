-- ============================================================================
-- 20260529180001_outbox_copy_handler.sql
-- Extend the event-bus consumer with a copy.trade_mirrored handler so copy
-- followers get a notification each time a provider trade is mirrored to them.
--
-- ADDITIVE: CREATE OR REPLACE of dispatch_outbox_events — same signature,
-- behaviour, and grants as 20260529170001; only adds one ELSIF branch. The
-- copy.fee_failed topic is already covered by the existing LIKE '%failed'
-- admin-alert branch.
-- ============================================================================
...
-- ============================================================================
-- END 20260529180001_outbox_copy_handler.sql
-- ============================================================================
