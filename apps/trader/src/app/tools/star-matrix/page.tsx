...
export default function StarMatrixPage() {
  return (
    <Shell title="Star Matrix Tools">
      <PageHeader
        title="Star Matrix"
      ...
      <Card className="mt-6">
        ...
        <CardBody className="text-sm text-steel">
          Star Matrix runs trend filters (MA crosses + ADX) on multiple timeframes and shows where
