      ...
      <div className="flex min-h-screen">
        ...
        <aside className="tech-panel2 flex w-64 shrink-0 flex-col border-r">
          <div className="flex items-center gap-2 px-5 py-5">
            <Cpu size={20} className="tech-accent" />
            <div>
              <div className="text-sm font-bold">Technology Hub</div>
              <div className="text-[10px] uppercase tracking-[0.18em] tech-muted">Super Admin</div>
            </div>
          </div>
